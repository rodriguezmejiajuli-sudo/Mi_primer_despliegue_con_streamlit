# -*- coding: utf-8 -*-
"""Copia de 7. Despliegue Venta de video juegos_publicado .ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1PcfAjUwxZzQw4A4JwYR4afb4sAVX7X42
...
#En despliegue drop_first= False (no le voy a borrar ninguna dummies)
...
#Se adicionan las columnas faltantes // hasta que no coincidan las varibales no ejecuta
data_preparada=data_preparada.reindex(columns=variables,fill_value=0)
data_preparada.head()

#Se normaliza la edad para predecir con Knn, Red, SVM //
# Si el modelo se normalizo esto aplica si selecciono arboles no debe normalizar
...
# con la copia de los datos se le pega la predidcion
